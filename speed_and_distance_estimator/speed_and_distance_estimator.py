...
class SpeedAndDistanceEstimator():
    def __init__(self):
        ...
        self.frame_rate = 24  # Frame rate of the video (frames per second)
        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id,_ in object_tracks[frame_num].items():
                    ...
                    speed_m_per_second = distance_covered / time_elapsed 
                    speed_km_per_hour = speed_m_per_second * 3.6  # convert to km/h
                    ...
                    for frame_num_batch in range(frame_num, last_frame):
                        if track_id in tracks[object][frame_num_batch]:
                            tracks[object][frame_num_batch][track_id]['speed'] = speed_m_per_second
