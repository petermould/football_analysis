...
class CameraMovementEstimator():
    ...
    def get_camera_movement(self,frames,read_from_stub=False, stub_path=None):
        ...
        for frame_num in range(1, len(frames)):
            ...
            if max_distance > self.minium_distance:
    ...
    def draw_camera_movement(self,frames,camera_movement_per_frame):
        ...
        for frame_num, frame in enumerate(frames):
            ...
            frame = cv2.putText(frame, f"Camera Movements", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            frame = cv2.putText(frame, f"X axes: {x_movement:.2f}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            frame = cv2.putText(frame, f"Y axes: {y_movement:.2f}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
